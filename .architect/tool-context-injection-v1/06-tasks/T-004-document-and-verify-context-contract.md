# Task: T-004-document-and-verify-context-contract
...
- Design Rule References: R-D001-002, R-D002-001, R-D003-002
...
## Functional Boundary
- Requested Functionality: Document the public contract and verify schema, injection, isolation, failure, visibility, and compatibility.
- Protected Functionality: Existing documentation structure and behavior of legacy tools and Agent APIs.
...
- Mandatory Stop Condition: Documentation or tests reveal an unapproved behavior change that cannot be explained by the approved design.

## Code Impact Scope
| Likely Code Location | Relevant Symbol or Area | Expected Work | Evidence or Rationale |
| --- | --- | --- | --- |
| README.md, openspec/specs, and tests/test_sdk.py | Relevant SDK seam | Make the smallest approved change | Approved D-design evidence; scope may expand only by recorded evidence. |
...
## MUST DO
- M-T004-001: Implement only the approved task boundary and preserve ordinary-tool behavior.

## MUST NOT DO
- N-T004-001: Do not introduce global, Agent-held, Tool-held, or publicly observable Context state.
